...
{
    public partial class CreatedProductssTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountPrice = table.Column<decimal>(type: "money", maxLength: 255, nullable: false),
                    ...
                    SecondImage = table.Column<string>(maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
